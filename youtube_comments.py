...
video_to_scrape = "https://www.youtube.com/watch?v=XcnEYDazhFQ&t=469s" # Provide YT Video URL

# driver = webdriver.Chrome("/opt/homebrew/bin/chromedriver") # Provide path to chrome driver
...
while scrolling == True:
    htmlelement = driver.find_element(By.XPATH, "/html/body")  # locate html tag
...
# df.to_excel('youtube_comments_two_cent.xlsx', index=False)

df.to_csv('youtube_comments_two_cent.csv', index=False)